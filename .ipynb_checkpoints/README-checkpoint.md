...
## Our Project
The goal of this project is to 1) understand (via a model) how different combinations of disturbances impact aboveground carbon and 2) use a model of these relationships to predict aboveground carbon across the Southern Rockies Ecoregion. 
